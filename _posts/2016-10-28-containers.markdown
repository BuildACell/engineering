...
We are developing two types of containers from E. coli: [Minicells](http://buildacell.io/engineering/minicells/2016/10/28/containers-minicells.html) (strain DS410) and [E-CRISPie cells](http://buildacell.io/engineering/containers/2016/10/28/containers-ecrispie.html) (strain MG1655 + DNAi).
